...
if (isMainThread) {
    ...
    module.exports.useSass = function (options) {
        ...
        function createWorker() {
            var _a;
            const worker = new Worker(__filename, { workerData: { ...options, importer: (_a = options.importer) === null || _a === void 0 ? void 0 : _a.toString() } });
    ...
    parentPort.on('message', (task) => {
        const { file } = task;
        const { css, stats: { includedFiles } } = sass.renderSync({ ...options, importer, file });
        parentPort.postMessage({ css, includedFiles });
    });
}
//# sourceMappingURL=useSass.js.map